...
Content Based Recommender System recommends movies similar to the movie user's likes and analyses the sentiments on the reviews given by the user for that movie.
